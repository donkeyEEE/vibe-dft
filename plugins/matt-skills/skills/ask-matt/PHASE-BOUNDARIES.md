...
| **`$matt-skills:handoff`** | Write a portable markdown file and seed a session anywhere with it. |
...
**3. Do you need to hand off?** `$matt-skills:handoff` is narrow. You need it only when you are:
...
That list is the whole clause. What `$matt-skills:handoff` buys is **portability** — a file that travels. If nothing is travelling, you don't need it.
...
| Secondary (`/compact`, `$matt-skills:handoff`) | Lossy       | Less  | Lots         |
