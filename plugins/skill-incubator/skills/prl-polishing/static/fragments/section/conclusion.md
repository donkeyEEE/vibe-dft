...
For a prediction, name the observable consequence without implying confirmation. For a computational result, state which conclusion is robust and which remains construction- or parameter-dependent.
