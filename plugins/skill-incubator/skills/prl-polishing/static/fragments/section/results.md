...
Results should answer `what happened` and make its immediate evidentiary role clear. In a compact Letter, a bounded interpretation may follow the observation in the same paragraph when it is required to advance the central inference.
...
Do not let a Results paragraph drift into interpretation syntax (`may reflect`, `suggests that`, `is likely due to`) unless the transition is intentional, the evidence has just been stated, and the boundary of the inference is explicit.
