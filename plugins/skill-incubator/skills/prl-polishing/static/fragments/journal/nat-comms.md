...
Do not restate facts that live in the shared ATOM CARD library. Reference the relevant `journal/nature-communications` cards when the user asks. Examples Claude should respond by reading shared facts:
